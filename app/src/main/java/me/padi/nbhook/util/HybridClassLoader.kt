...
//        }
        ...
        if (hostClassLoader != null && isHostClass(name)) {
            try {
    ...
    companion object {
        private val sBootClassLoader: ClassLoader? = Context::class.java.getClassLoader()
        ...
        fun setLoaderParentClassLoader(loaderClassLoader: ClassLoader?) {
            if (loaderClassLoader === HybridClassLoader::class.java.getClassLoader()) {
         ...
         */
        fun isHostClass(name: String): Boolean {
